...
>([
  ...
  ["ein leerzeichen fehlt", { key: "leerzeichen_fehlt", anzahl: 1 }],
  ["zwei leerzeichen fehlen", { key: "leerzeichen_fehlt", anzahl: 2 }],
  ["eine worttrennung [leerzeichen] fehlt", { key: "leerzeichen_fehlt", anzahl: 1 }],
  ["ein leerzeichen zu viel", { key: "leerzeichen_zu_viel", anzahl: 1 }],
